...
export const FiltersBar: React.FC<FiltersBarProps> = ({ table }) => {
  return (
    <div className="flex flex-nowrap items-center gap-3 border-y border-white/10">
      <div className="min-w-[100px] border-r border-white/10"><ChainFilter table={table} /></div>
      <div className="min-w-[120px] border-r border-white/10"><MaxAgeFilter table={table} /></div>
      <div className="min-w-[125px] border-r border-white/10"><MinMcapFilter table={table} /></div>
      <div className="min-w-[120px] border-r border-white/10"><MinVolumeFilter table={table} /></div>
